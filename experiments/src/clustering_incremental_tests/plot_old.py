...
if __name__ == "__main__":
    ...
    plot([
        ("tsptw", "tsptw/AFG",  ["Cluster","Gewoon"],"min"),
        ("knapsack", "knapsack", ["Cluster","Gewoon"],"max"),
        ("misp", "misp", ["Cluster","Gewoon"],"max"),
        ("sop", "sop", ["Cluster","Gewoon"],"min"),
        ])
    
    plot([
        ("tsptw", "tsptw/AFG",  ["Dominance","Gewoon","Cluster","Dominance+Cluster"],"min"),
        ("knapsack", "knapsack", ["Dominance","Gewoon","Cluster","Dominance+Cluster"],"max"),
        ("sop", "sop", ["Dominance","Gewoon","Cluster","Dominance+Cluster"],"min"),
        ])
